...
/* Lecture: Abstracting OpenGL into Classes */

//----------------------------------------------------------------------------------
// Lesson: Abstracting to Renderer file (Renderer.h) 
//----------------------------------------------------------------------------------
...
int main(void)
{
	...
	std::cout << glGetString(GL_VERSION) << std::endl;
	{
		...
		//----------------------------------------------------------------------------------
		// Lesson: Abstracting Vertex Buffer and Index Buffer (VertexBuffer.h, IndexBuffer.h)
		//----------------------------------------------------------------------------------
		//// The vertex buffer
		//unsigned int buffer;
		...
		while (!glfwWindowShouldClose(window))
		{
			...
			//----------------------------------------------------------------------------------
			// Lesson: Binding index buffer is now a class method.
			//----------------------------------------------------------------------------------
			//GLCall(glBindBuffer(GL_ELEMENT_ARRAY_BUFFER, ibo));
		...
		//----------------------------------------------------------------------------------
		// Lesson: glfwTerminate deletes OpenGl context
		//----------------------------------------------------------------------------------
		// The glGetError (indices, etc not terminated) will return an error is if there 
		// is no OpenGL context.
		// Solution: Use scope to free indices... etc before glfwTerminate.
		//----------------------------------------------------------------------------------
	}
	glfwTerminate();
	return 0;
