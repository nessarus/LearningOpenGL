...
/* Lecture: Setting up a Test Framework for OpenGL */
...
int main(void)
{
	...
	std::cout << glGetString(GL_VERSION) << std::endl;
	{
		...
		//----------------------------------------------------------------------------------
		// Lesson: Setting up Test Framework 
		//----------------------------------------------------------------------------------
		...
		while (!glfwWindowShouldClose(window))
		{
			...
			//----------------------------------------------------------------------------------
			// Lesson: creating test
			//----------------------------------------------------------------------------------
			//// does nothing
			//test.OnUpdate(0.0f);

			//// colors window to updated color.
			//test.OnRender();
